...
function [Tout,Xout,Vout,Aout,Jeout]=disp_spline_o_2(X0,V0,A0,                 ...
                        XF,VF,AF,                 ...
                        tF,Durations,Signs,       ...
   ...
   Tout = zeros(NbDof,NbPoints);
   Xout = zeros(NbDof,NbPoints);
   Vout = zeros(NbDof,NbPoints);
   Aout = zeros(NbDof,NbPoints);
   Jeout = zeros(NbDof,NbPoints);
